...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{asset('assests-fe/assets/favicon.ico')}}"/>
    <!-- Bootstrap icons-->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css" rel="stylesheet"/>
    <!-- Core theme CSS (includes Bootstrap)-->
    <link href="{{asset('assests-fe/css/styles.css')}}" rel="stylesheet"/>
</head>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    @foreach($menu as $dm)
                        ...
                        @else
                            <li class="nav-item">
                                <a href="{{$dm['url']}}" class="nav-link" target="{{$dm['target']}}"></a>
                            </li>
                        @endif
                    @endforeach
                </ul>
...
<!-- Core theme JS-->
<script src="{{asset('assests-fe/js/scripts.js')}}"></script>
</body>
</html>
